...
public class GuardianNewsTestStepDef {
	...
	public void user_perform_search_the_same_news_article_on_google_and_obtains_the_number_of_similar_articles_on_google() throws IOException {
	...
	public void user_perform_search_the_same_news_article_on_bbc_and_obtains_the_number_of_similar_articles_on_bbc() throws IOException {
	...
	public void the_news_article_from_guardian_news_page_should_considered_valid_if_the_number_of_similar_articles_on_other_sources_is_greater_than_or_equal_to(Integer expectedCount) {
		
		Assert.assertTrue(guardianNewsPO.isNewsArticleValidOrInvalid(countGoogle, countBBC, expectedCount), "News from The Guardian is invalid ");
	}
}
