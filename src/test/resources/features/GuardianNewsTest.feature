...
Feature: Verifying The Guardian news article authenticity to prevent fake news.
  ...
  @smoke @regression @p1
  Scenario: Verify the authenticity of The Guardians first news article by cross-referencing with other sources.
  ...
  @regression @p2
  Scenario: Verify the authenticity of The Guardians second news article by cross-referencing with other sources.
    Given User launch The Guardian URL and navigate to news page "/tone/news"
